window.onload=function(){
	...
	var Txt=document.getElementsByClassName('wrap')
    ...
    //创建地图函数：
    function createMap(){
        var map = new BMap.Map("address");//在百度地图容器中创建一个地图
    ...
    //标注点数组
    var markerArr = [{title:"",content:"i am here~",point:"113.451838|23.167502",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
    ...
    function createIcon(json){
        var icon = new BMap.Icon("../images/map.jpg", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
        return icon;
    }
